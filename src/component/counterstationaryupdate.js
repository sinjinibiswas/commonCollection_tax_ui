...
const CounterStationaryUpdate = () => {
    ...
    const [counterWiseStationaryStockAdd, setCounterWiseStationaryStockAdd] = useState([])
    const addStockRow = (event) => {
        event.preventDefault();
        const newCenterWiseStationaryStock = [...counterWiseStationaryStockAdd];
        setCounterWiseStationaryStockAdd([...counterWiseStationaryStockAdd,
        {
        }
        ]);
    }
            ...
            <NavBar />
                <main>
                                                ...
                                                <div className="row">
                                                    <div className="col-md-12" id="business">
                                                        <div className="panel-body">
                                                            <p className="col-md-8 control-label text-left"> <b>CENTER WISE STATIONARY PRINTED</b></p>
                                                            <hr />
                                                            <p className="col-md-8 control-label text-left"><b> Stationary Search Criteria </b></p> <br />
                                                            <div className="row" style={{ marginTop: "6px" }}>
                                                                <label className="col-md-2 control-label text-left" >Department: <span className="star">* <span></span></span></label>
                                                                <div className="col-md-2">
                                                                    ...
                                                                    >
                                                                        <option value="">Common Collection</option>
                                                                        <option value=""></option>
                                                                        <option value=""></option>
                                                                    </select>
                                                                </div>
                                                                ...
                                                                <div className="col-md-2">
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <option value=""> BEHALA </option>
                                                                    </select>
                                                                </div>

                                                                <label className="col-md-2 control-label text-left" >Date: <span className="star">* <span></span></span></label>
                                                                <div className="col-md-2">
                                                                    <input
                                                                        type="text"
                                                                        className="form-control"
                                                            ...
                                                            <br />
                                                            <div className="row" style={{ marginTop: "6px" }}>
                                                                <label className="col-md-2 control-label text-left" >Type: <span className="star">* <span></span></span></label>
                                                                <div className="col-md-2">
                                                                    <select
                                                                        id="s1"
                                                                        name="chartofaccounts.id"
                                                                        className="form-control"
                                                                    >
                                                                        <option value="">Common Receipt</option>
                                                                        <option value=""> Unpaid Amount Receipt </option>
                                                                    </select>
                                                                </div>
                                                                <label className="col-md-2 control-label text-left" >Counter: <span className="star">* <span></span></span></label>
                                                                <div className="col-md-2">
                                                                    <select
                                                                        id="s1"
                                                                        name="chartofaccounts.id"
                                                                            ...
                                                                            <table className="table">
                                                                                <thead>
                                                                                    <tr>
                                                                                        ...
                                                                                        <th scope="col">Stationary Number</th>
                                                                                    </tr>
                                                                                </thead>
                                                                                <tbody>
                    ...
                    <AlertBox
                        ...
                        ConfirmText="Are you sure you want to update the counter stationary details?"
                        ConfirmYesText="Yes"
                        ConfirmNoText="No"
...
export default CounterStationaryUpdate;
