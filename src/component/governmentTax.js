...
const GovernmentCommonTax = () => {
  ...
  // Dropdown change
  const handleDropdownChange = (dropdownid, id, value, rowId) => {
  ...
  const handlePayableAmount = (value, index) => {
  ...
  const handleChange2 = (event) => {
    ...
    newPay[0].paymentMode = event.target.value;
                                                ...
                                                <tr >
                                                  ...
                                                  <td>
                                                    <input
                                                      ...
                                                      className="form-check-input"
                                                      id="exampleCheck1"
                                                      onChange={(index) => handlePayableAmount(item.payableAmount, index)}
                                                    />
                                                  </td>
                                                </tr>
                                              )
                                                  ...
                                                  <tr key={index}>
                                                    ...
                                                    <td>
                                                      {/* <select
                                                        ...
                                                        {
                                                          paymentModeDropdown && paymentModeDropdown.map((item, index) => {
                                                            return (
                                                              <option key={index} value={item.paymentMode}>
                                                                {item.paymentMode}
                                                              </option>
                                                            )
                                                          })
                                                    ...
                                                    <td>
                                                      <input
                                                        ...
                                                        aria-label=""
                                                        aria-describedby="basic-addon1"
                                                        disabled={item.paymentMode == "" || item.paymentMode == "Cash"}
                                                      />
                                                    </td>
                                                    <td>
                                                      <input
                                                    ...
                                                    <td>
                                                      <input id="comBankCode" className="form-control" placeholder="Search Bank" type="text" onChange={(e) => handleBankNameSearch(e.target.value)}
                                                        value={selectedBankNameList} disabled={item.paymentMode == "" || item.paymentMode == "Cash"} />
                                                      {
                                                    ...
                                                    <input id="comBankBranchName" className="form-control" placeholder="Search Branch" type="text" onChange={(e) => handleBranchNameListSearch(e.target.value)}
                                                        value={selectedBranchNameList} disabled={item.paymentMode == "" || item.paymentMode == "Cash"} />
                                                      {
...
export default GovernmentCommonTax;
