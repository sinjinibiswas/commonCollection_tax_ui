                                                ...
                                                <div className="row">
                                                    <div className="col-md-12" id="business">
                                                        <div className="panel-body">
                                                            <p className="col-md-8 control-label text-left"> <b>ADD NEW COUNTER FOR COLLECTION</b></p>
                                                            <hr />
                                                            <p className="col-md-8 control-label text-left"><b> Counter Details </b></p> <br /> 
                                                            <div className="row" style={{ marginTop: "6px" }}>
                                                                <label className="col-md-3 control-label text-left" >IP Address: <span className="star">* <span></span></span></label>
                                                                ...
                                                                <label className="col-md-3 control-label text-left" >New Counter No.: <span className="star">* <span></span></span></label>
                                                                <div className="col-md-3">
                                                                    <input
                                                                        type="text"
                                                                        className="form-control"
                                                            ...
                                                            <br/>
                                                            <div className="row" style={{ marginTop: "6px" }}>
                                                                <label className="col-md-3 control-label text-left" >Receipt No.: <span className="star">* <span></span></span></label>
                                                                <div className="col-md-3">
                                                                    <input
                                                                        type="text"
                                                                        className="form-control"
                                                                ...
                                                                <label className="col-md-3 control-label text-left" >Financial Year: <span className="star">* <span></span></span></label>
                                                                <div className="col-md-3">
                                                                    <input
                                                                        type="text"
                                                                        className="form-control"
                                                            ...
                                                            <br/>
                                                            <div className="row" style={{ marginTop: "6px" }}>
                                                                <label className="col-md-3 control-label text-left" >Common Collection: <span className="star">* <span></span></span></label>
                                                                <div className="col-md-3">
                                                                    <input
                                                                        type="text"
                                                                        className="form-control"
