                                                ...
                                                <div className="row">
                                                    <div className="col-md-12" id="business">
                                                        <div className="panel-body">
                                                            <p className="col-md-8 control-label text-left"> <b>SEARCH COUNTER DETAILS</b></p>
                                                            <hr />
                                                            <p className="col-md-8 control-label text-left"><b> Counter Search </b></p> <br />
                                                            <div className="row" style={{ marginTop: "6px" }}>
                                                                <label className="col-md-2 control-label text-left" >Office: <span className="star">* <span></span></span></label>
                                                                ...
                                                                <label className="col-md-2 control-label text-left" >IP Address.: <span className="star">* <span></span></span></label>
                                                                <div className="col-md-2">
                                                                    <input
                                                                        type="text"
                                                                        className="form-control"
