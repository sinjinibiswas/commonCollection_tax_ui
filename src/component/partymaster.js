                                    ...
                                    <div className="application1">
                                        <form action="" method="post" role="form" className="">
                                            <div className="form1">
                                                <div className="row">
                                                    <div className="col-md-12" id="business">
                                                        <div className="panel-body">
                                                            <p className="col-md-8 control-label text-left"> <b>PARTY SEARCH PAGE</b></p>
                                                            <hr />
                                                            <p className="col-md-8 control-label text-left"><b>Search Criteria</b></p> <br />
                                                            <div className="row" style={{ marginTop: "6px" }}>
                                                                <label className="col-md-2 control-label text-left" >Party Code: <span className="star">* <span></span></span></label>
                                                                ...
                                                                <label className="col-md-2 control-label text-left" >Party Name: <span className="star">* <span></span></span></label>
                                                                <div className="col-md-2">
                                                                <input
                                                                        type="text"
                                                                        className="form-control"
                                                            ...
                                                            {show == true ?
                                                                <div>
                                                                    ...
                                                                    <div className="form-group">
                                                                        {" "}
                                                                        <p className="col-md-8 control-label text-left"><b>Search Details</b></p>
                                                                        <hr />
                                              ...
                                              return ( */}
                                                                                    <tr >
                                                                                        <td scope="row">0978</td>
                                                                                        <td>A.P Enterprise</td>
                                                                                        <td>11/2, RABINDRA PALLY,NC PUKUR, BARACK, PIN- 700122</td>
